        ...
        <div className="container relative mx-auto px-3 md:px-4 max-w-6xl z-20">
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-4 md:gap-12">
            ...
            <div className="w-full md:w-1/2 relative z-30 pointer-events-auto">
              <form className="space-y-3 md:space-y-6 relative">
                <input 
                  type="text" 
                  name="user_name"
                  required
                ...
                <button 
                  type="submit"
                  className="w-full bg-gradient-to-r from-purple-600 to-purple-800 text-white text-xs md:text-xl px-3 md:px-6 py-2 md:py-3 rounded-md md:rounded-lg font-semibold hover:from-purple-700 hover:to-purple-900 transition-all duration-300 transform hover:scale-105 relative z-30 pointer-events-auto"
                >
                  Send Message
                </button>
              </form>
