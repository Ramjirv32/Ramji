...
const addClassNameRecursively = (
  ...
  const foo = (child: ReactNode) => {
    ...
    return cloneElement(child as React.ReactElement<any>, {
      className: `${(child as React.ReactElement<any>).props.className || ""} ${className}`.trim(),
      children: addClassNameRecursively((child as React.ReactElement<any>).props.children, className),
    });
  };
