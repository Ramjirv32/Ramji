    ...
    <div className="flex items-center justify-center">
      <Modal>
        <ModalTrigger className="bg-transparent flex justify-center group/modal-btn">
          <div
            className="relative w-[400px] h-[267px] rounded-lg overflow-hidden border-2 border-zinc-800 hover:border-zinc-600 transition-all duration-300"
          >
            <Image
            ...
            <div className="absolute w-full h-1/2 bottom-0 left-0 bg-gradient-to-t from-black via-black/85 to-transparent pointer-events-none z-10">
              <div className="flex flex-col h-full items-start justify-end p-6">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <div className="text-xs bg-zinc-700 text-white rounded-lg w-fit px-2">
                    {project.date}
                  </div>
                </div>
              </div>
